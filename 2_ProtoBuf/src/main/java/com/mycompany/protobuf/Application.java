...
import com.mycompany.protobuf.Training.Student;
import com.mycompany.protobuf.Training.Student.PhoneNumber;
import com.mycompany.protobuf.Training.Student.PhoneType;
...
public class Application {
    ...
    private List<Student> createTestStudents() {
        ...
        Student student1 = createStudent(1, "John", "Doe", "john.doe@mycompany.com", Arrays.asList(phone1));

        PhoneNumber phone2 = createPhone("234567", PhoneType.LANDLINE);
        Student student2 = createStudent(2, "Richard", "Roe", "richard.roe@mycompany.com", Arrays.asList(phone2));

        PhoneNumber phone3_1 = createPhone("345678", PhoneType.MOBILE);
        PhoneNumber phone3_2 = createPhone("456789", PhoneType.LANDLINE);
        Student student3 = createStudent(3, "Jane", "Doe", "jane.doe@mycompany.com", Arrays.asList(phone3_1, phone3_2));
