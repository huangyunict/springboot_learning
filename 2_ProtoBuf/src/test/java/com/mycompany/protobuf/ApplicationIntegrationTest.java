...
public class ApplicationIntegrationTest {
    ...
    private void assertResponse(String response) {
        ...
        assertThat(response, containsString("john.doe@mycompany.com"));
        assertThat(response, containsString("richard.roe@mycompany.com"));
        assertThat(response, containsString("jane.doe@mycompany.com"));
